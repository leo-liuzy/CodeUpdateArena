...
prog_syn_sys_prompt_template = environment.from_string(
    f"""
...
unit_test_skeleton_sys_prompt_template = environment.from_string(
    f"""
...
unit_test_skeleton_input_prompt_template = environment.from_string(
    f"""
...
unit_test_ans_sys_prompt_template = environment.from_string(
    f"""
You are a very experienced programer. You are good at algorithmic reasoning and writing super high quality code.
...
unit_test_ans_input_prompt_template = environment.from_string(
    f"""
{{% if include_api_info %}}
...
unit_test_assert_sys_prompt_template = environment.from_string(
    f"""
You are a very experienced programer. You are good at algorithmic reasoning and writing super high quality code.
...
unit_test_assert_input_prompt_template = environment.from_string(
    f"""
[TEST]
{{{{unit_test_skeleton}}}}
[/TEST]
...
solution_new_sys_prompt_template = environment.from_string(
    f"""
You are a very experienced programer. You are good at algorithmic reasoning and writing super high quality code.
...
solution_new_input_prompt_template = environment.from_string(
    f"""
[PROBLEM]
{{{{problem}}}}
[/PROBLEM]
